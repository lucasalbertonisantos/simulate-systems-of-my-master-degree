...
public class CidadaoRespostaFila {
	...
	private List<EnderecoRespostaFila> enderecos;
	private List<ProfissaoRespostaFila> profissoes;
	private List<String> emails;
	private List<TelefoneRespostaFila> telefones;
	@JsonFormat(pattern="yyyy-MM-dd")
	...
	public List<EnderecoRespostaFila> getEnderecos() {
		return enderecos;
	}
	public void setEnderecos(List<EnderecoRespostaFila> enderecos) {
		this.enderecos = enderecos;
	}
	public List<ProfissaoRespostaFila> getProfissoes() {
		return profissoes;
	}
	public void setProfissoes(List<ProfissaoRespostaFila> profissoes) {
	...
	public List<TelefoneRespostaFila> getTelefones() {
		return telefones;
	}
	public void setTelefones(List<TelefoneRespostaFila> telefones) {
