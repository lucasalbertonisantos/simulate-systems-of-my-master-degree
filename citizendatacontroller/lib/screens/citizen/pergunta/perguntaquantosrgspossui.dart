...
class PerguntaQuantosRgsPossui extends StatelessWidget {
  ...
  PerguntaQuantosRgsPossui(this.pergunta, this.loginApiClient, this.cidadaoApiClient,
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Digite a quantidade de RGs',
                  ),
  ...
  void _enviarResposta(BuildContext context) {
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      int quantidadeRgs = int.parse(respostaController.text);
      return ExecutarComunicacaoApi<StatusPerguntaFlow>(
        ...
        PerguntaProximoPassoService(
            loginApiClient, cidadaoApiClient, perguntaApiClient, cpf, quantidadeRgs: quantidadeRgs),
      );
    }));
  }
}
