...
class PerguntaFlow extends StatelessWidget {
  ...
  PerguntaFlow(this.pergunta, this.loginApiClient, this.cidadaoApiClient,
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'pergunta.label',
                    hintText: 'pergunta.hint',
                  ),
                ),
              ),
              RaisedButton(
